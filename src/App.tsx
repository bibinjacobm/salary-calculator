  ...
  const downloadPDF = () => {
    ...
    printContent.innerHTML = `
      <html>
        ...
        <body>
          <h1>Salary Calculator <span style="font-size: 14px; color: #999;">v.1.62</span></h1>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold">Salary Calculator <span className="text-sm text-gray-400">v.1.62</span></h1>
